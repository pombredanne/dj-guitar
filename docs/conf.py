# Django Guitar documentation build configuration file.
#
...
from guitar import __version__
...
project = "Django Guitar"
copyright = "2017, Pascal Polleunus"
...
# See: https://www.sphinx-doc.org/en/stable/intl.html
# language = None
...
# See: https://www.sphinx-doc.org/en/stable/theming.html
html_theme = "default"
...
html_short_title = "v{release} doc"
...
htmlhelp_basename = "dj-guitar-doc"
...
latex_documents = [
    (
        ...
        "dj-guitar.tex",  # Target name
        "Django Guitar Documentation",  # Title
        "Pascal Polleunus",  # Author
...
man_pages = [
    (
        "index",  # Source start file
        "dj-guitar",  # Name
        "Django Guitar Documentation",  # Description
        ["Pascal Polleunus"],  # Authors
        1,  # Manual section
    ),
]
...
texinfo_documents = [
    (
        "index",  # Source start file
        "dj-guitar",  # Target name
        "Django Guitar Documentation",  # Title
        "Pascal Polleunus",  # Author
        "dj-guitar",  # Dir menu entry
        "Complementary core components for Django.",  # Description
